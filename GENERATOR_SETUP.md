...
An Nx workspace generator for scaffolding new OpenCode plugin packages has been successfully created.
...
The generator uses Nx's built-in utilities - no extra packages required! Just ensure Nx is installed:
