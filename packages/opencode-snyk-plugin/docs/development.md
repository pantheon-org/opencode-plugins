...
This guide covers how to develop and contribute to the Snyk plugin.

## Setup

```bash
# Clone the repository
git clone https://github.com/pantheon-org/opencode-snyk-plugin.git
cd opencode-snyk-plugin
...
```text
opencode-snyk-plugin/
├── src/      # Plugin source code
├── docs/     # Documentation source
├── pages/    # Documentation site builder
└── dist/     # Build output
```
