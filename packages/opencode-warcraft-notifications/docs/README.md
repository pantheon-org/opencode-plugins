...
OpenCode plugin for WarcraftNotifications

## Installation

\`\`\`bash bun add @pantheon-org/opencode-warcraft-notifications \`\`\`

## Usage

Add the plugin to your `opencode.json`:

\`\`\`json { "plugin": ["@pantheon-org/opencode-warcraft-notifications"] } \`\`\`
