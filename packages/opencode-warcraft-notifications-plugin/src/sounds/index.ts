...
export { allianceSoundDescriptions, hordeSoundDescriptions, soundDescriptions, getSoundDescription };
 ...
 */
export const getSoundPath = (filename: string, faction: 'alliance' | 'horde', dataDir?: string): string => {
