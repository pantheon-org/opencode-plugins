...
export const hordeSounds = {
  ...
  orcAcknowledge: ['orc_acknowledge1.wav', 'orc_acknowledge2.wav', 'orc_acknowledge3.wav', 'orc_acknowledge4.wav'],
  ...
  ogreSelected: ['ogre_selected1.wav', 'ogre_selected2.wav', 'ogre_selected3.wav', 'ogre_selected4.wav'],
  ...
  ogreMageAcknowledge: ['ogre_mage_acknowledge1.wav', 'ogre_mage_acknowledge2.wav', 'ogre_mage_acknowledge3.wav'],
  ...
  hordeShipAcknowledge: ['horde_ship_acknowledge1.wav', 'horde_ship_acknowledge2.wav', 'horde_ship_acknowledge3.wav'],
