...
export const allianceSounds = {
  ...
  elfAcknowledge: ['elf_acknowledge1.wav', 'elf_acknowledge2.wav', 'elf_acknowledge3.wav', 'elf_acknowledge4.wav'],
  knightSelected: ['knight_selected1.wav', 'knight_selected2.wav', 'knight_selected3.wav', 'knight_selected4.wav'],
  knightAcknowledge: [
  ...
  peasantSelected: ['peasant_selected1.wav', 'peasant_selected2.wav', 'peasant_selected3.wav', 'peasant_selected4.wav'],
  peasantAcknowledge: [
