...
This guide covers how to develop and contribute to the Gitlab plugin.
...
git clone https://github.com/pantheon-org/opencode-gitlab-plugin.git cd opencode-gitlab-plugin
...
\`\`\` opencode-gitlab-plugin/ ├── src/ # Plugin source code ├── docs/ # Documentation source ├── pages/ # Documentation
