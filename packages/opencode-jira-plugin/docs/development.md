...
This guide covers how to develop and contribute to the OpencodeJira plugin.
...
git clone https://github.com/pantheon-org/opencode-jira-plugin.git cd opencode-jira-plugin
...
\`\`\` opencode-jira-plugin/ ├── src/ # Plugin source code ├── docs/ # Documentation source ├── pages/ # Documentation
