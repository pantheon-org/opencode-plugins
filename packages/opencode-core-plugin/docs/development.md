...
This guide covers how to develop and contribute to the OpencodeCorePlugin plugin.
...
git clone https://github.com/pantheon-org/opencode-core-plugin.git cd opencode-core-plugin
...
\`\`\` opencode-core-plugin/ ├── src/ # Plugin source code ├── docs/ # Documentation source ├── pages/ # Documentation
site builder └── dist/ # Build output \`\`\`
