...
This document describes the API provided by the OpencodeCorePlugin plugin.
...
export const OpencodeCorePluginPlugin: Plugin = async (ctx) => { return { // Plugin implementation } } \`\`\`
