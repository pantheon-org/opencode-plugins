...
function generateReport() {
    ...
    console.log(`  Broken links:           ${results.brokenLinks.length > 0 ? colors.red : colors.green}${results.brokenLinks.length}${colors.reset}`);
...
// Run the script
main();
//# sourceMappingURL=validate-docs-links.js.map