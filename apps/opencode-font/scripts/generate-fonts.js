...
import { ALPHABET, SYMBOLS } from '../src/alphabet/index';
// ============================================================================
// Configuration
// ============================================================================
const CONFIG = {
...
function generateTTF(svgFont) {
    ...
    const buf = Buffer.from(ttf.buffer);
    return buf;
}
/**
 * Convert TTF to WOFF2 (primary web format)
 */
function generateWOFF2(ttfBuffer) {
    console.log('📦 Compressing to WOFF2...');
    const woff2Uint8 = ttf2woff2(ttfBuffer);
 ...
 */
function generateWOFF(ttfBuffer) {
    console.log('📦 Compressing to WOFF...');
    const woffResult = ttf2woff(ttfBuffer);
    const woffBuffer = Buffer.from(woffResult.buffer || woffResult);
 ...
 */
function saveFonts(ttf, woff2, woff) {
...
//# sourceMappingURL=generate-fonts.js.map