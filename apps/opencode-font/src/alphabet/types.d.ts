 ...
 */
export declare const getAvailableCharacters: () => string[];
/**
 * Get available symbols in the font
 */
export declare const getAvailableSymbols: () => string[];
/**
 * Get all available characters (letters and symbols combined)
 */
export declare const getAllAvailableCharacters: () => string[];
